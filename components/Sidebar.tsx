      ...
      <div className="p-6 border-t border-white/5 bg-black/40 backdrop-blur-3xl">
        <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3 overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <span className="text-[8px] text-gray-500 uppercase tracking-widest font-bold">Public Bypass</span>
                      </div>
                    </div>
                </div>
                <button 
            ...
            <div className="flex items-center justify-center gap-2 py-2 opacity-30 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
               ...
               <span className="text-[8px] font-black uppercase tracking-[0.3em]">Bypass Mode Active</span>
            </div>
        </div>
      </div>
    </div>
